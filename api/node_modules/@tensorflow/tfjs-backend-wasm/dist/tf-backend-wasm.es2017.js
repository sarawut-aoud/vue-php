...
(function (global, factory) {
     ...
     * =============================================================================
     */
    const acosConfig = createUnaryKernelConfig(tfjsCore.Acos);
     ...
     * =============================================================================
     */
    const acoshConfig = createUnaryKernelConfig(tfjsCore.Acosh);
     ...
     * =============================================================================
     */
    const argMaxConfig = createArgMinMaxKernelConfig(tfjsCore.ArgMax);
     ...
     * =============================================================================
     */
    const argMinConfig = createArgMinMaxKernelConfig(tfjsCore.ArgMin);
     ...
     * =============================================================================
     */
    const asinConfig = createUnaryKernelConfig(tfjsCore.Asin);
     ...
     * =============================================================================
     */
    const asinhConfig = createUnaryKernelConfig(tfjsCore.Asinh);
     ...
     * =============================================================================
     */
    const atanConfig = createUnaryKernelConfig(tfjsCore.Atan);
     ...
     * =============================================================================
     */
    const atan2Config = createBinaryKernelConfig(tfjsCore.Atan2);
     ...
     * =============================================================================
     */
    const atanhConfig = createUnaryKernelConfig(tfjsCore.Atanh);
    ...
    function avgPool3D(args) {
        ...
        const convInfo = tfjsCore.backend_util.computePool3DInfo(x.shape, filterSize, strides, 
    ...
    function avgPool3DGrad(args) {
        ...
        const { filterSize, strides, pad, dimRoundingMode } = attrs;
        const convInfo = tfjsCore.backend_util.computePool3DInfo(input.shape, filterSize, strides, /*dilations=*/ 1, pad, dimRoundingMode);
    ...
    function avgPoolGrad(args) {
        ...
        const convInfo = tfjsCore.backend_util.computePool2DInfo(input.shape, filterSize, strides, 
        /*dilations=*/ 1, pad);
        const dx = backend.makeOutput(input.shape, input.dtype);
     ...
     * =============================================================================
     */
    const bitwiseAndConfig = createBinaryKernelConfig(tfjsCore.BitwiseAnd);
    ...
    function conv3DBackpropFilterV2(args) {
        ...
        const convInfo = tfjsCore.backend_util.computeConv3DInfo(x.shape, filterShape, strides, 
        /*dilations=*/ 1, pad);
    ...
    function conv3DBackpropInputV2(args) {
        ...
        const convInfo = tfjsCore.backend_util.computeConv3DInfo(inputShape, filter.shape, strides, /*dilations=*/ 1, pad);
    ...
    function dilation2D(args) {
        ...
        const dilationInfo = tfjsCore.backend_util.computeDilation2DInfo(x.shape, filter.shape, strides, pad, 
     ...
     * =============================================================================
     */
    const erfConfig = createUnaryKernelConfig(tfjsCore.Erf);
     ...
     * =============================================================================
     */
    const expm1Config = createUnaryKernelConfig(tfjsCore.Expm1, 'float32');
     ...
     * =============================================================================
     */
    const isFiniteConfig = createUnaryKernelConfig(tfjsCore.IsFinite, 'bool');
     ...
     * =============================================================================
     */
    const isInfConfig = createUnaryKernelConfig(tfjsCore.IsInf, 'bool');
     ...
     * =============================================================================
     */
    const isNaNConfig = createUnaryKernelConfig(tfjsCore.IsNan, 'bool');
     ...
     * =============================================================================
     */
    const log1pConfig = createUnaryKernelConfig(tfjsCore.Log1p);
    ...
    function maxPoolWithArgmax(args) {
        ...
        tfjsCore.util.assert(x.shape.length === 4, () => `Error in maxPool: input must be rank 4 but got rank ${x.shape.length}.`);
        const dilations = [1, 1];
     ...
     * =============================================================================
     */
    const modConfig = createBinaryKernelConfig(tfjsCore.Mod);
     ...
     * =============================================================================
     */
    const reciprocalConfig = createUnaryKernelConfig(tfjsCore.Reciprocal);
     ...
     * =============================================================================
     */
    const seluConfig = createUnaryKernelConfig(tfjsCore.Selu);
     ...
     * =============================================================================
     */
    const signConfig = createUnaryKernelConfig(tfjsCore.Sign);
     ...
     * =============================================================================
     */
    const sinhConfig = createUnaryKernelConfig(tfjsCore.Sinh);
     ...
     * =============================================================================
     */
    const softplusConfig = createUnaryKernelConfig(tfjsCore.Softplus);
    ...
    function tensorScatterUpdate(args) {
        ...
        const { sliceRank, numUpdates, sliceSize, strides, outputSize } = tfjsCore.scatter_util.calculateShapes(updates, indices, tensor.shape);
        const indicesData = backend.dataIdMap.get(indices.dataId);
        const indicesId = indicesData.id;
        const updatesData = backend.dataIdMap.get(updates.dataId);
        const updatesId = updatesData.id;
