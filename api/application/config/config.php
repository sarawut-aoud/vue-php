...
// $config['base_url'] = 'https://gtsgeerang.local/';
...
|
*/
$config['encryption_key'] = 'encry@2018-ci.gen_23k423l9a';
...
$config['sess_cookie_name'] = 'ci_session_gen';
...
$config['csrf_exclude_uris'] = array(
  ...
  'https://betatest.geerang.com/api/.*+',
  'login/do_login'
);
